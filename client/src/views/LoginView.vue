    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div class="fadeIn first">
                <img src="@/assets/events.png" id="icon" alt="User Icon" />
            </div>
...
<script>
import json from "../../public/users.json";
...
export default {
    ...
    methods: {
        login() {
            ...
            let userFound = users.find(user => user.user === this.user && user.password === this.password)
            if (userFound) {
                console.log('Login successful');
                localStorage.token = userFound;
                if (userFound.department == "finance") {
